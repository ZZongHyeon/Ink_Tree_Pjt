...
COMMENTSTATUS VARCHAR2(10) DEFAULT 'Y'
);
...
REVIEWSTATUS VARCHAR2(1) DEFAULT 'Y',           -- 상태 (Y: 활성, N: 삭제)
CONSTRAINT FK_REVIEW_BOOK FOREIGN KEY (BOOKNUMBER) REFERENCES BOOKINFO(BOOKNUMBER) ON DELETE CASCADE,
...
CONSTRAINT FK_REVIEW_HELPFUL_REVIEW FOREIGN KEY (REVIEWID) REFERENCES BOOK_REVIEW(REVIEWID) ON DELETE CASCADE,
...
CREATE TABLE NOTIFICATIONS(   ID NUMBER, 
...
CREATE TABLE TRADE_TAG_MASTER (
    tag_code NUMBER PRIMARY KEY,
    tag_type VARCHAR2(10) NOT NULL,   -- 'GOOD' or 'BAD'
    tag_label VARCHAR2(100) NOT NULL,  -- '응답 빠름', '무례함' 등
...
-------------------------------------------------값추가
-- 좋은 태그 (100000 ~ 100009)
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100000, 'GOOD', '응답 빠름', '메시지나 문의에 빠르게 답변');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100001, 'GOOD', '정확한 설명', '상품 상태를 솔직하고 자세히 설명');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100002, 'GOOD', '포장 깔끔', '상품 포장이 꼼꼼하고 안전');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100003, 'GOOD', '시간 약속 준수', '거래 시간 약속을 잘 지킴');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100004, 'GOOD', '친절함', '대화가 부드럽고 친절');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100005, 'GOOD', '정확한 가격', '합리적 가격 책정');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100006, 'GOOD', '정직함', '상품 상태, 거래 조건 숨김 없음');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100007, 'GOOD', '재구매 의사 있음', '다시 거래하고 싶은 사람');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100008, 'GOOD', '신속한 배송', '배송 속도가 빠름');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (100009, 'GOOD', '커뮤니케이션 원활', '문의 시 친절하게 소통');

-- 나쁜 태그 (200000 ~ 200009)
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200000, 'BAD', '응답 지연', '메시지 답장이 느림');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200001, 'BAD', '거짓 정보', '상품 상태를 부풀리거나 숨김');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200002, 'BAD', '포장 부실', '배송 중 파손 가능성이 있는 포장');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200003, 'BAD', '시간 약속 불이행', '약속 시간에 늦거나 나타나지 않음');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200004, 'BAD', '무례함', '거래 중 언행이 불친절');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200005, 'BAD', '가격 과다', '비합리적인 가격 요구');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200006, 'BAD', '환불/취소 불가', '문제 발생 시 협조 부족');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200007, 'BAD', '배송 지연', '배송이 느리거나 예고 없이 지연');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200008, 'BAD', '연락 두절', '거래 중 연락이 끊김');
INSERT INTO TRADE_TAG_MASTER (TAG_CODE, TAG_TYPE, TAG_LABEL, TAG_EXPLAN) VALUES (200009, 'BAD', '신뢰 부족', '거래 자체가 불안정하거나 의심됨');
...
CREATE SEQUENCE SEQ_TRADE_RECORD_ID START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_TRADE_REVIEW_ID START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
