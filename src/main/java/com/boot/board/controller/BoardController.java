...
public class BoardController {
	...
	public ResponseEntity<Map<String, Object>> bc_modify(@RequestParam("commentNumber") int commentNumber,
...
//	}
	...
	public String boardViewDetail(@RequestParam HashMap<String, String> param, Model model, CriteriaDTO criteriaDTO, HttpServletRequest request,
...
//	    UserDTO user = (UserDTO) session.getAttribute("loginUser");
	...
	public String commentWriteOk(@RequestParam HashMap<String, String> param) {
		...
		if (param.get("commentContent") == "") {
			...
			return "redirect:/board/detail_view?boardNumber=" + boardNumber + "&skipViewCount=true";
		}
