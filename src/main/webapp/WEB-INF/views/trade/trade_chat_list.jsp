...
<% pageContext.setAttribute("dateFormatter", java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")); %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/trade_chat_list.css">
                            ...
                            <div class="chat-info">
                                <div class="chat-header">
									...
									<span class="chat-time">
									    ${room.lastMessageTime.format(dateFormatter)}
									</span>
                                </div>
                                <div class="chat-preview">${room.lastMessage}</div>
                                <div class="post-info">
                                    <span class="post-title">${room.postTitle}</span>
                                    <span class="post-price"><fmt:formatNumber value="${room.postPrice}" pattern="#,###" />원</span>
                                    <span class="post-status ${room.postStatus == 'AVAILABLE' ? 'available' : room.postStatus == 'RESERVED' ? 'reserved' : 'sold'}">
