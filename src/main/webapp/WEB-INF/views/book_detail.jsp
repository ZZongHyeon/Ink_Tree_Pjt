...
<link rel="stylesheet" type="text/css"
	href="/resources/css/book_detail.css">
						...
						<div class="book-status">
							...
							<div class="book-count">
								...
								<button class="action-button edit-button"
									onclick="location.href='/update_book?bookNumber=${book.bookNumber}'">
...
<%-- 								<a href="/add_wishlist?bookNumber=${book.bookNumber}" --%>
					...
					<c:forEach items="${relatedBooks}" var="relatedBook">
						<div class="related-book-card">
							...
							<div class="related-book-info">
								...
								<a
									href="/book_detail?bookNumber=${relatedBook.bookNumber}"
