...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p class="page-subtitle">잉크트리는 이용자의 개인정보를 소중히 여기며, 관련 법령을 준수하고 있습니다.</p>
            ...
            <div class="privacy-main">
                <div id="section1" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        <p>잉크트리는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p>
                        ...
                        <div class="highlight-box">
                            <p>잉크트리는 이용자의 개인정보를 수집할 때 반드시 사전에 이용자에게 해당 사실을 알리고 동의를 구하고 있습니다.</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="section2" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        <p>잉크트리는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
                ...
                <div id="section3" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        <p>잉크트리는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.</p>
                ...
                <div id="section4" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        <p>잉크트리는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.</p>
                ...
                <div id="section5" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        ...
                        <p>이용자 및 법정 대리인의 권리 행사는 잉크트리에 대해 서면, 전화, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 잉크트리는 이에 대해 지체 없이 조치하겠습니다.</p>
                        ...
                        <p>잉크트리는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 "개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.</p>
                    </div>
                </div>
                ...
                <div id="section6" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        <p>잉크트리는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다.</p>
                ...
                <div id="section7" class="privacy-card">
                    ...
                    <div class="privacy-content">
                        <p>잉크트리는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
                        ...
                        <p>이용자는 잉크트리의 서비스를 이용하면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 잉크트리는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</p>
                    </div>
                </div>
